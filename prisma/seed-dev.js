...
async function upsertCourseWithContent({ slug, title, description, coverImage, audience, modulesData }) {
    ...
    for (const moduleData of modulesData) {
        ...
        for (const lessonData of moduleData.lessons) {
            const lessonSlug = `${slug}-${moduleData.order}-${lessonData.order}`
